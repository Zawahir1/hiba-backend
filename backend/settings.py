...
SECRET_KEY = "django-insecure-rbg05u_g-kx&l-xr+!yg4hw593-3p!%-ls0r!3!sji+p=7#^ij"
...
SIMPLE_JWT = {
    ...
    "AUTH_COOKIE": "access_token",  # Custom access token name
    "AUTH_COOKIE_REFRESH": "refresh_token",  # Custom refresh token name
